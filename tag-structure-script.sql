...
VALUES ('AgusTaylor54', 44656032,'72Crwl3B6O8XHFTEkR4X0w==','agustintaylor@gmail.com', '2002-09-25','/images/fotoDePerfil123.jpg');
...
('Shingeki no kyojin','15.png','La historia se desarrolla en un mundo ficticio en el que la humanidad está al borde de la extinción a causa de unas criaturas humanoides llamadas «titanes», lo que obliga a los sobrevivientes a refugiarse en tres enormes murallas que impiden el acceso a dichos monstruos.',1),
('20 century boy','16.jpeg','En 1969, Kenji y sus amigos del colegio escribieron el Libro de las Profecías, en el que narraban cómo una organización maligna destruía el mundo y un grupo de nueve héroes salvaba a la humanidad.',1),
('Vagabond','17.jpeg','Vagabond (????? "Vagabundo") es una serie de manga épica de artes marciales escrita y dibujada por Takehiko Inoue. Relata la historia del guerrero más famoso de Japón, Musashi Miyamoto, basándose en Musashi, la novela escrita por Eiji Yoshikawa.', 1),
...
('Hajime no ippo','19.jpeg','Ippo Makunouchi (??? ?? Makunouchi Ippo) es un chico muy reservado y muy tímido de 17 años que trabaja con su madre en un negocio familiar de botes para pesca llamado tienda de pesca makunouchi  Debido a ello él nunca tiene tiempo libre para dedicarse a los deportes o hacer amigos.',1),
